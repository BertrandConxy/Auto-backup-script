...
class MyDrive():
    ...
    def find_backup_folder(self):
        ...
        get_folders = self.service.files().list(
        ...
        if not get_folders['files']:
            ...
            parent_folder = self.service.files().create(body=folder_metadata, fields="id").execute()
    ...
    def upload_files(self, filename, path):
        ...
        find_file = self.service.files().list(
        ...
        if len(find_file['files']) == 0:
            ...
            self.service.files().create(body=file_metadata, media_body=file_to_upload, fields='id').execute()
